<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="" prop="cstoreId">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['application:cstore:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="cstoreList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="" align="center" prop="cstoreId" />
      <el-table-column label="" align="center" prop="uId" />
      <el-table-column label="" align="center" prop="tel" />
      <el-table-column label="" align="center" prop="cardId" />
      <el-table-column label="" align="center" prop="name" />
      <el-table-column label="" align="center" prop="license" width="100">
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除商家申请编号为"' + _cstoreIds + '"的数据项？').then(function() {
